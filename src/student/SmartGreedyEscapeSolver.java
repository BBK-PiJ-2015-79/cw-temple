 ...
 */
public class SmartGreedyEscapeSolver implements EscapeSolver {
    ...
    private void constructTreeMap(HashMap<Node, EscapeNodeStatus> searchTreeMap, Node start, Node end) {
        ...
        while(!queue.isEmpty()) {
            ...
            queue.sort((n1,n2) -> {
                int n1Distance = searchTreeMap.get(n1).getPathDistance();
                int n1Gold = searchTreeMap.get(n1).getGoldOnPath();
                int n2Distance = searchTreeMap.get(n2).getPathDistance();
                int n2Gold = searchTreeMap.get(n2).getGoldOnPath();
